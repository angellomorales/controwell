...
public class CtrlPrincipal implements ActionListener {
    ...
    public CtrlPrincipal(FrmPrincipal frmPrincipal, FrmProceso frmProceso, FrmProcesoAlarmas frmProcesoAlarmas, FrmPozos frmPozos, FrmAforoTk frmAforoTk, FrmTanques frmTanques, FrmGraficas frmGraficas, FrmReporte frmReporte,FrmSeries frmSeries, FrmEditarProceso frmEditarProceso,CtrlPozos ctrlPozos, CtrlProceso ctrlProceso, CtrlProcesoAlarmas ctrlProcesoAlarmas, CtrlActualizar ctrlActualizar, CtrlAforoTk ctrlAforoTk, CtrlTanques ctrlTanques, CtrlGraficas ctrlGraficas, CtrlReporte ctrlReporte,CtrlEditarProceso ctrlEditarProceso) {
